...
class RecicleAtlas(Manager):
    ...
    def extract_information_about_recicles(self) -> bool or None:
        self.send_requisitons_requests(
            "https://atlasbrasileirodareciclagem.ancat.org.br/static/js/main.0d42bcb2.chunk.js"
        )
                    ...
                    if len(cities) > 0:
                        for city in tqdm(cities, desc="by_city"):
                            self.by_city[city.get("city")] = {
                                ...
                                "cooperatives_anmes": ";".join(
                                    city.get("cooperativeNames", list())
                                ),
                            }
